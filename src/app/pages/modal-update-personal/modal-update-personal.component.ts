...
export class ModalUpdatePersonalComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		this.formPersonalUpdate.controls['categoria'].setValue(this.personal.categoria);
		this.formPersonalUpdate.controls['area'].setValue(this.personal.area.id_area);
		this.formPersonalUpdate.controls['usuario'].setValue(this.personal.usuario.id_usuario);
	}
