...
export class ModalUpdateComponent implements OnInit {
	...
	ngOnInit(): void {
		this.formCitasUpdate.controls['comentario'].setValue(this.cita.comentario);
		this.formCitasUpdate.controls['fecha_cita'].setValue(this.cita.fecha_cita);
		this.formCitasUpdate.controls['sede'].setValue(this.cita.sede.id_sede);
		this.formCitasUpdate.controls['paciente'].setValue(this.cita.paciente.id_paciente);
	...
	saveCita() {
		this._citasSrv.putCita(this.formCitasUpdate.value, this.date, this.cita.id_cita).subscribe(resp => {
