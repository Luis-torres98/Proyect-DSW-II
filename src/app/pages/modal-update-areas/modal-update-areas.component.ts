...
export class ModalUpdateAreasComponent implements OnInit {
	...
	saveCita() {
		console.log(this.area.id_area, this.formAreaUpdate.value.nombre);

		this._citasSrv.putArea(this.area.id_area, this.formAreaUpdate.value.nombre).subscribe(resp => {
